...
import "../styles/UserAccVideoItem.scss";
              ...
              <tr>
                ...
                <td className="UserAccItemDetails">
                  ...
                  <div className="UserAccItemViews">
                    <FaEye className="UserAccEye" /> {getViewText(video.views)} ● Created:{" "}
                ...
                <button className="BtnUserAccVidEdit"><FaPen className="m-1"/></button>
                </Link>
                <button onClick={handleDelete} className="BtnUserAccVidDel"><FaTrash className="m-1"/></button>
                </div>
                </td>
              </tr>
            </tbody>
